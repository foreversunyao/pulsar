 ...
 *
 */
public class ProxyConnectionDetail extends PulsarHandler implements FutureListener<Void> {
    ...
    public ProxyConnectionDetail(ProxyService proxyService, SslContext sslCtx) {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProxyConnectionDetail.class);
